...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("~/GitHub/Introducao_Ciencias_de_Dados/Cadernos/Figuras/DE.jpg"), 
               alt = 'logo', 
...
```{r, echo=FALSE}
htmltools::img(src = knitr::image_uri("~/GitHub/Introducao_Ciencias_de_Dados/Cadernos/Figuras/ufam.png"), 
               alt = 'logo', 
               width = 180, height = 180,
